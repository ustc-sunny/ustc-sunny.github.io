...
## Preprint
- <span style="font-family: Arial; font-size:medium;">**He Sun**, Jinrui Zhou, Li Li, Mingjun Xiao. "CooperLLM: Cloud–Edge–End Cooperative Federated Fine-tuning for LLMs via ZOO-based Gradient Correction", Arxiv' 26 </span>
...
- <span style="font-family: Arial; font-size:medium;"><a style="color: #0000FF;"><b>[VLDB'26]</b></a> **He Sun**, Li Li, Mingjun Xiao, "Accelerating Long-context LLM Inference on a PC." 52nd International Conference on Very Large Data Bases, 2026 (Under Review)
- <span style="font-family: Arial; font-size:medium;"><a style="color: #ff0000;"><b>[ICASSP'25]</b></a> Zijie Lin, Yiqing Shen, Qilin Cai, **He Sun**, Jinrui Zhou, Mingjun Xiao. "AutoP2C: An LLM-Based Agent Framework for Code Repository Generation from Multimodal Content in Academic Papers", ICASSP' 2026[[Paper]](https://arxiv.org/pdf/2504.20115?)
