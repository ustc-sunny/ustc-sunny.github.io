...
- <span style="font-family: Arial; font-size:medium;"><a style="color: #0000FF;"><b>[ToN'26]</b></a> **He Sun**, Jinrui Zhou, Li Li, Yebo Wu, Mingjun Xiao, et al. "Zeroth-Order Federated LLM Fine-tuning with Cloud-assisted Gradient Rectification using Synthetic Training Data", IEEE Transactions on Networking, 2026 (Under Review)
